...
namespace PontoPortaria1510.Totalizador.Tests
{
    ...
    public class TotalizadorTests
    {
        ...
        public void HoraSemanalTest()
        {
            ...
            new Calculo.CalculoPonto().CalculaMes(pontos);
            ...
            Assert.AreEqual(Convert.ToDateTime("02:00").TimeOfDay, totalizadores[2].Horas50);
            Assert.AreEqual(Convert.ToDateTime("04:15").TimeOfDay, totalizadores[2].Horas100);
